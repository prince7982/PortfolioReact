...
const Contact = () => {
  ...
  const onSubmit = async(data) => {
       ...
       try{
        await axios.post("https://getform.io/f/aejyownb", userInfo);
  ...
  return (
    ...
    <div name='Contact' className='max-w-screen-2xl container mx-auto px-4 md:px-20 my-16'>
        ...
        <div className='flex flex-col items-center justify-center mt-5'>
            ...
            //  action="https://getform.io/f/aejyownb" method="POST" 
             className='bg-slate-200 w-96 px-8 py-6 rounded-xl'>
                ...
                <div className='flex flex-col mb-4'>
                    ...
                    {...register("email", { required: true })}
                     className='shadow rounded-lg appearance-none border py-2 px-3 text-gray-700 leading-tight'
                     type="text" id='email' name='email' placeholder='Enter your email address' />
                ...
                <div className='flex flex-col mb-4'>
                    ...
                    {...register("message", { required: true })}
                     className='shadow rounded-lg appearance-none border py-2 px-3 text-gray-700 leading-tight'
                     type="text" id='message' name='message' placeholder='Enter your Query' />
